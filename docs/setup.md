...
> **Note**: `npx skills add` installs 9 skills only. For the full experience (agents + 14 pipelines), use the **One-Click Install**.
...
> **注意**：`npx skills add` 僅安裝 9 個 Skills。如需完整體驗（Agent + 14 條流水線），請使用**一鍵安裝**。
